...
to be silenced. Alarms triggered by overheat will not be silenced since that is
a critical event.
...
Responses will be generated by all Nodes that respond to this request.

===================== ======== ===== =========================================================
Value                 Format   Bytes Description
===================== ======== ===== =========================================================
Product Type          uint8_t  1     Type of device responding to the request. See `Product Type`_
Probe Serial Number   uint32_t 4     Probe Serial number
Node Serial Number    uint8_t  10    Serial number of device responding
===================== ======== ===== =========================================================
...
Product Type            uint8_t  1     This node's `Product Type`_
...
Product Type          uint8_t  1     This device's `Product Type`_
